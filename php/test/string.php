<?php 
# EOD = End Of Document ;EOD = End Of Data; EOT = End of Text
...
echo "<br/>";
/* 
	在 PHP 5.3.0 以后，也可以用 Heredoc 构来初始化静态变量和类的属性和常量： 
*/
...
echo <<<'EOT'
My name is "$name". I am printing some $foo2->foo.
Now, I am printing some {$foo2->bar[1]}.
This should not print a capital 'A': \x41
EOT;
echo "<br/>";

/* Note:
	不象 heredoc 结构，nowdoc 结构可以用在任意的静态数据环境中，
	最典型的示例是用来初始化类的属性或常量：
...
*/
$foox = 1 + "10.5";                // $foo is float (11.5)
$foox = 1 + "-1.3e3";              // $foo is float (-1299)
$foox = 1 + "bob-1.3e3";           // $foo is integer (1)
$foox = 1 + "bob3";                // $foo is integer (1)
$foox = 1 + "10 Small Pigs";       // $foo is integer (11)
$foox = 4 + "10.2 Little Piggies"; // $foo is float (14.2)
$foox = "10.0 pigs " + 1;          // $foo is float (11)
$foox = "10.0 pigs " + 1.0;        // $foo is float (11)  


echo "\$foox==$foox; type is " . gettype ($foox) . "<br />\n";
